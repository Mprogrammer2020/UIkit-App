...
public enum PopoverOption {
    ...
    case cornerRadiusPopover(CGFloat)
    ...
    case borderColorPopover(UIColor)
}
...
open class Popover: UIView {
    ...
    open var cornerRadiusPopover: CGFloat = 6.0
    ...
    open var borderColorPopover: UIColor?
    ...
    open func show(_ contentView: UIView, point: CGPoint, inView: UIView) {
        ...
        self.contentView.layer.cornerRadius = self.cornerRadiusPopover
    ...
    override open func draw(_ rect: CGRect) {
        ...
        case .up:
            ...
            arrow.addLine(to: CGPoint(x: self.cornerRadiusPopover, y: self.bounds.height - self.arrowSize.height))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.cornerRadiusPopover,
                    y: self.bounds.height - self.arrowSize.height - self.cornerRadiusPopover
                ),
                radius: self.cornerRadiusPopover,
                startAngle: self.radians(90),
                endAngle: self.radians(180),
                clockwise: true)
            
            arrow.addLine(to: CGPoint(x: 0, y: self.cornerRadiusPopover))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.cornerRadiusPopover,
                    y: self.cornerRadiusPopover
                ),
                radius: self.cornerRadiusPopover,
            ...
            arrow.addLine(to: CGPoint(x: self.bounds.width - self.cornerRadiusPopover, y: 0))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.bounds.width - self.cornerRadiusPopover,
                    y: self.cornerRadiusPopover
                ),
                radius: self.cornerRadiusPopover,
            ...
            arrow.addLine(to: CGPoint(x: self.bounds.width, y: self.bounds.height - self.arrowSize.height - self.cornerRadiusPopover))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.bounds.width - self.cornerRadiusPopover,
                    y: self.bounds.height - self.arrowSize.height - self.cornerRadiusPopover
        ...
        case .down, .auto:
            ...
            if self.isCloseToCornerRightArrow && !self.isCornerRightArrow {
                if !isBehindCornerRightArrow {
                    arrow.addLine(to: CGPoint(x: self.bounds.width - self.cornerRadiusPopover, y: self.arrowSize.height))
                    arrow.addArc(
                        withCenter: CGPoint(x: self.bounds.width - self.cornerRadiusPopover, y: self.arrowSize.height + self.cornerRadiusPopover),
                        radius: self.cornerRadiusPopover,
                        startAngle: self.radians(270.0),
                        endAngle: self.radians(0),
                        clockwise: true)
                } else {
                    arrow.addLine(to: CGPoint(x: self.bounds.width, y: self.arrowSize.height + self.cornerRadiusPopover))
                ...
                arrow.addArc(
                    withCenter: CGPoint(
                        x: self.bounds.width - self.cornerRadiusPopover,
                        y: self.arrowSize.height + self.cornerRadiusPopover
                    ),
                    radius: self.cornerRadiusPopover,
                    startAngle: self.radians(270.0),
                    endAngle: self.radians(0),
            ...
            arrow.addLine(to: CGPoint(x: self.bounds.width, y: self.bounds.height - self.cornerRadiusPopover))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.bounds.width - self.cornerRadiusPopover,
                    y: self.bounds.height - self.cornerRadiusPopover
                ),
                radius: self.cornerRadiusPopover,
                startAngle: self.radians(0),
                endAngle: self.radians(90),
            ...
            arrow.addLine(to: CGPoint(x: 0, y: self.arrowSize.height + self.cornerRadiusPopover))
        ...
        case .left:
            ...
            arrow.addLine(to: CGPoint(x:self.bounds.width - self.arrowSize.height, y: self.bounds.height - self.cornerRadiusPopover))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.bounds.width - self.arrowSize.height - self.cornerRadiusPopover,
                    y: self.bounds.height - self.cornerRadiusPopover
                ),
                radius: self.cornerRadiusPopover,
            ...
            arrow.addLine(to: CGPoint(x: self.cornerRadiusPopover, y: self.bounds.height))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.cornerRadiusPopover,
                    y: self.bounds.height - self.cornerRadiusPopover
            ...
            arrow.addLine(to: CGPoint(x: self.bounds.width - self.arrowSize.height - self.cornerRadiusPopover, y: 0))
            arrow.addArc(
                withCenter: CGPoint(x: self.bounds.width - self.arrowSize.height - self.cornerRadiusPopover,
                                    y: self.cornerRadiusPopover
                                   ),
                radius: self.cornerRadiusPopover,
                startAngle: self.radians(270),
        ...
        case .right:
            ...
            arrow.addArc(
                withCenter: CGPoint(
                    x: arrowPoint.x + self.arrowSize.height + self.cornerRadiusPopover,
                    y: self.bounds.height - self.cornerRadiusPopover
                ),
                radius: self.cornerRadiusPopover,
            ...
            arrow.addLine(to: CGPoint(x: self.bounds.width + arrowPoint.x - self.cornerRadiusPopover, y: self.bounds.height))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.bounds.width + arrowPoint.x - self.cornerRadiusPopover,
                    y: self.bounds.height - self.cornerRadiusPopover
                ),
                radius: self.cornerRadiusPopover,
                startAngle: self.radians(90),
            ...
            arrow.addLine(to: CGPoint(x: self.bounds.width + arrowPoint.x, y: self.cornerRadiusPopover))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.bounds.width + arrowPoint.x - self.cornerRadiusPopover,
                    y: self.cornerRadiusPopover
            ...
            arrow.addLine(to: CGPoint(x: arrowPoint.x + self.arrowSize.height - self.cornerRadiusPopover, y: 0))
            arrow.addArc(
                withCenter: CGPoint(x: arrowPoint.x + self.arrowSize.height + self.cornerRadiusPopover,
                                    y: self.cornerRadiusPopover
                                   ),
                radius: self.cornerRadiusPopover,
                startAngle: self.radians(-90),
        ...
        color.setFill()
        arrow.fill()
        if let borderColor = borderColorPopover {
    ...
    func setOptions(_ options: [PopoverOption]?){
        if let options = options {
            for option in options {
                ...
                case let .cornerRadiusPopover(value):
                    self.cornerRadiusPopover = value
                ...
                case let .borderColorPopover(value):
                    self.borderColorPopover = value
                }
            }
        }
    }
